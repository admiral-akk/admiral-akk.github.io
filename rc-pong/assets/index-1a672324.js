...
void main() {\r
  ...
  outColor.w = 1.;\r
}`,lt=new ai;lt.showPanel(0);document.body.appendChild(lt.dom);const d=document.getElementById("webgl").getContext("webgl2");Gl(d);function J(t,e,n,r,i=null,o=null){t.useProgram(e.program),at(t,e,n),st(e,r),Ot(t,i),o&&t.viewport(o[0],o[1],o[2],o[3]),Bt(t,n)}const Jl={position:{numComponents:3,data:[-1,-1,0,1,-1,0,-1,1,0,-1,1,0,1,-1,0,1,1,0]}},Q=Rt(d,Jl),B=new ri;B.init();const cn=new Vr(1),Ql=new Vl(cn),Zl=new Or,Fe=new jl(B),ae=`#version 300 es
in vec2 position;
void main() {
...
`;oe(d,[ae,tc]);const St=oe(d,[ae,rc]),oc=oe(d,[ae,zr]),sc=oe(d,[ae,zr]),Ze=oe(d,[ae,ec]),ac=oe(d,[ae,nc]),Ln=oe(d,[ae,ic]),lc=oe(d,[ae,Kl]),cc=oe(d,[ae,ql]);function Bn(t,e,n,r){const s=oe(d,[`#version 300 es
    in vec2 position;
    in vec4 color;
    in mat4 matrix;
    ...
    void main() {
      outColor = v_color;
    }`]),a=Ui,l=[],c=[],{ball:u,balls:f}=r.data.state;for(let P=0;P<f.length;P++){const w=f[P],U=a.scaling([w.size,w.size,w.size]),O=a.translation([w.position[0]/w.size,w.position[1]/w.size,0]);a.multiply(U,O).forEach((z,Y)=>{l.push(z)}),c.push(w.color[0],w.color[1],w.color[2],1)}const h=a.scaling([u.size,u.size,u.size]),p=a.translation([u.position[0]/u.size,u.position[1]/u.size,0]);a.multiply(h,p).forEach((P,w)=>{l.push(P)}),c.push(u.color[0],u.color[1],u.color[2],1);const b=[],E=32;for(var x=0;x<=E;x++)b.push(Math.sin(x*Math.PI*2/E),Math.cos(x*Math.PI*2/E));const y=Rt(d,{position:{numComponents:2,data:b},color:{numComponents:4,data:c,divisor:1},matrix:{numComponents:16,data:l,divisor:1}}),_=Dn(d,s,y);d.useProgram(s.program),at(d,s,_),st(s,{}),Ot(d,e),Bt(d,_,d.TRIANGLE_FAN,_.numElements,0,f.length+1);const S=[],R=[],{paddles:C}=r.data.state;for(let P=0;P<C.length;P++){const w=C[P],U=a.scaling([w.size[0],w.size[1],1]),O=a.translation([w.position[0]/w.size[0],w.position[1]/w.size[1],0]);a.multiply(U,O).forEach((z,Y)=>{S.push(z)}),R.push(w.color[0],w.color[1],w.color[2],1)}const V=Rt(d,{position:{numComponents:2,data:[1,1,1,-1,-1,-1,-1,1]},color:{numComponents:4,data:R,divisor:1},matrix:{numComponents:16,data:S,divisor:1}}),H=Dn(d,s,V);d.useProgram(s.program),at(d,s,H),st(s,{}),Ot(d,e),Bt(d,_,d.TRIANGLE_FAN,_.numElements,0,C.length)}cn.listeners.push({updateSize:({width:t,height:e})=>{d.canvas.width=t,d.canvas.height=e}});let un=!1;B.addButton({name:"Save Image",fn:()=>{un=!0}});const uc=()=>{var e=document.getElementById("webgl").toDataURL(),n=document.createElement("a");n.download="canvas_image.png",n.href=e,n.click(),un=!1},N=8*128,ee=N,g={lightEmitters:Z(d,[{internalFormat:d.RGBA8,format:d.RGBA,mag:d.NEAREST,min:d.NEAREST,wrap:d.CLAMP_TO_EDGE,auto:!0}],N,ee),lightEmittersWithCurrent:Z(d,[{internalFormat:d.RGBA8,format:d.RGBA,mag:d.NEAREST,min:d.NEAREST,wrap:d.CLAMP_TO_EDGE,auto:!0}],N,ee),distance:Z(d,[{internalFormat:d.RGBA8,format:d.RGBA,mag:d.LINEAR,min:d.LINEAR,wrap:d.CLAMP_TO_EDGE,auto:!0}],N,ee),fill:Z(d,[{internalFormat:d.RGBA8,format:d.RGBA,mag:d.NEAREST,min:d.NEAREST,wrap:d.CLAMP_TO_EDGE,auto:!0}],N,ee),spare:Z(d,[{internalFormat:d.RGBA8,format:d.RGBA,mag:d.NEAREST,min:d.NEAREST,wrap:d.CLAMP_TO_EDGE,auto:!0}],N,ee),cascadeRT:Z(d,[{internalFormat:d.RGBA32F,format:d.RGBA,mag:d.LINEAR,min:d.LINEAR,wrap:d.CLAMP_TO_EDGE,auto:!0}],2*N,ee),spareCascadeRT:Z(d,[{internalFormat:d.RGBA32F,format:d.RGBA,mag:d.LINEAR,min:d.LINEAR,wrap:d.CLAMP_TO_EDGE,auto:!0}],2*N,ee),linearCascadeRT:Z(d,[{internalFormat:d.RGBA32F,format:d.RGBA,mag:d.LINEAR,min:d.LINEAR,wrap:d.CLAMP_TO_EDGE,auto:!0}],2*N,ee),quadCascadeRT:Z(d,[{internalFormat:d.RGBA32F,format:d.RGBA,mag:d.LINEAR,min:d.LINEAR,wrap:d.CLAMP_TO_EDGE,auto:!0}],N,ee),spareQuadCascadeRT:Z(d,[{internalFormat:d.RGBA32F,format:d.RGBA,mag:d.LINEAR,min:d.LINEAR,wrap:d.CLAMP_TO_EDGE,auto:!0}],N,ee),finalCascadeRT:Z(d,[{internalFormat:d.RGBA32F,format:d.RGBA,mag:d.LINEAR,min:d.LINEAR,wrap:d.CLAMP_TO_EDGE,auto:!0}],N,ee),finalCascadeRTSpare:Z(d,[{internalFormat:d.RGBA32F,format:d.RGBA,mag:d.LINEAR,min:d.LINEAR,wrap:d.CLAMP_TO_EDGE,auto:!0}],N,ee)};B.addColor({displayName:"Color",defaultValue:[1,1,1],callback:t=>{Fe.commands.push(new UpdateColorCommand(t))}});function $r(t){lt.begin(),cn.update(),Zl.update(Fe,Ql.getState()),Fe.update(),kl(d.canvas),d.viewport(0,0,d.canvas.width,d.canvas.height),J(d,Ze,Q,{color:[0,0,0,0]},g.lightEmittersWithCurrent),Bn(t,g.lightEmittersWithCurrent,.05,Fe),J(d,Ze,Q,{color:[0,0,0,0]},g.spare),[g.fill,g.spare]=[g.spare,g.fill];for(var e=Math.ceil(Math.log2(N));e>=0;e--)J(d,ac,Q,{resolution:[g.fill.width,g.fill.height],jumpSize:1<<e,tPrev:g.fill.attachments[0],tLine:g.lightEmittersWithCurrent.attachments[0]},g.spare),[g.fill,g.spare]=[g.spare,g.fill];J(d,oc,Q,{resolution:[g.fill.width,g.fill.height],tPrev:g.fill.attachments[0]},g.distance);const n=B.addNumber({displayName:"Start Depth",defaultValue:Math.log2(N)-3,min:1,max:Math.log2(N)-3,step:1}).value,r=B.addNumber({displayName:"Final Depth",defaultValue:0,min:0,max:8,step:1}).value;let o=B.addNumber({displayName:"Initial Depth",defaultValue:Math.log2(N)-3,min:1,max:Math.log2(N)-3,step:1}).value;for(J(d,Ze,Q,{color:[0,0,0,0]},g.cascadeRT),J(d,Ze,Q,{color:[0,0,0,0]},g.quadCascadeRT),g.cascadeRT.width;o>=r;){const s=10*Math.SQRT2/g.cascadeRT.width,l=Math.log2(Math.SQRT2/s),c=o===0?0:s*Math.pow(2,l*(o-1)/n),u=o==n?Math.SQRT2:s*Math.pow(2,l*o/n),f=s*Math.pow(2,l*(o+1)/n);J(d,lc,Q,{renderResolution:[d.canvas.width,d.canvas.height],resolution:[g.quadCascadeRT.width,g.quadCascadeRT.height],maxSteps:B.addNumber({displayName:"Max Steps",defaultValue:32,min:1,max:128,step:1}).value,tDistance:g.distance.attachments[0],tColor:g.lightEmittersWithCurrent.attachments[0],startDepth:n,current:{depth:o,minDistance:c,maxDistance:u},deeper:{depth:o,minDistance:u,maxDistance:f},debug:{continousBilinearFix:B.addNumber({displayName:"Continuous Bilinear Fix",defaultValue:!0}).value,cornerProbes:B.addNumber({displayName:"Corner Probes",defaultValue:!0}).value,showSampleUv:B.addNumber({displayName:"Show Sample Uv",defaultValue:!1}).value,showProbeUv:B.addNumber({displayName:"Show Probe Uv",defaultValue:!1}).value,showDirection:B.addNumber({displayName:"Show Direction Uv",defaultValue:!1}).value,noFix:B.addNumber({displayName:"No Fix",defaultValue:!1}).value,quadSample:B.addNumber({displayName:"Quad Sample",defaultValue:!1}).value,finalDepth:B.addNumber({displayName:"Final Depth",defaultValue:0,min:0,max:8,step:1}).value},tPrevCascade:g.quadCascadeRT.attachments[0]},g.spareQuadCascadeRT),[g.spareQuadCascadeRT,g.quadCascadeRT]=[g.quadCascadeRT,g.spareQuadCascadeRT],o--}switch(J(d,St,Q,{resolution:[g.linearCascadeRT.width,g.linearCascadeRT.height],renderTarget:[0,0,1,1],tPrev:g.cascadeRT.attachments[0]},g.linearCascadeRT),J(d,sc,Q,{resolution:[d.canvas.width,d.canvas.height],tPrev:g.fill.attachments[0]}),J(d,St,Q,{resolution:[d.canvas.width,d.canvas.height],tPrev:g.cascadeRT.attachments[0]}),B.addEnum({displayName:"Render Mode",defaultValue:"Render Cascade",options:["Render Cascade","Cascade Levels"]}).value){case"Cascade Levels":J(d,St,Q,{renderTarget:[B.addNumber({displayName:"minx",defaultValue:0,min:0,max:1,step:.01}).value,B.addNumber({displayName:"miny",defaultValue:0,min:0,max:1,step:.01}).value,B.addNumber({displayName:"maxx",defaultValue:1,min:0,max:1,step:.01}).value,B.addNumber({displayName:"maxy",defaultValue:1,min:0,max:1,step:.01}).value],resolution:[g.quadCascadeRT.width,g.quadCascadeRT.height],tPrev:g.quadCascadeRT.attachments[0]},g.spareQuadCascadeRT),J(d,Ln,Q,{resolution:[d.canvas.width,d.canvas.height],tPrev:g.spareQuadCascadeRT.attachments[0]});case"Render Cascade":default:J(d,cc,Q,{resolution:[g.spareQuadCascadeRT.width,g.spareQuadCascadeRT.height],tPrevCascade:g.quadCascadeRT.attachments[0]},g.spareQuadCascadeRT);break}Bn(t,g.spareQuadCascadeRT,.05,Fe),J(d,Ln,Q,{resolution:[d.canvas.width,d.canvas.height],tPrev:g.spareQuadCascadeRT.attachments[0]}),un&&uc(),lt.end(),requestAnimationFrame($r)}requestAnimationFrame($r);
//# sourceMappingURL=index-1a672324.js.map
