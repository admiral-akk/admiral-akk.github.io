...
void main() {\r
  ...
  outColor.w = 1.;\r
}`,ct=new xi;ct.showPanel(0);document.body.appendChild(ct.dom);const m=document.getElementById("webgl").getContext("webgl2");ql(m);function Q(t,e,n,r,i=null,o=null){t.useProgram(e.program),ze(t,e,n),zr(e,r),wt(t,i),o&&t.viewport(o[0],o[1],o[2],o[3]),At(t,n)}const sc={position:{numComponents:3,data:[-1,-1,0,1,-1,0,-1,1,0,-1,1,0,1,-1,0,1,1,0]}},Z=dt(m,sc),I=new hi;I.init();const vn=new Zr(1),ac=new Zl(vn),lc=new Yr,Fe=new rc(I),ae=`#version 300 es
in vec2 position;
void main() {
