...
void main() {\r
  ...
  outColor.w = 1.;\r
}`,at=new pi;at.showPanel(0);document.body.appendChild(at.dom);const m=document.getElementById("webgl").getContext("webgl2");Kl(m);function Q(t,e,n,r,i=null,o=null){t.useProgram(e.program),ze(t,e,n),Or(e,r),At(t,i),o&&t.viewport(o[0],o[1],o[2],o[3]),Et(t,n)}const oc={position:{numComponents:3,data:[-1,-1,0,1,-1,0,-1,1,0,-1,1,0,1,-1,0,1,1,0]}},Z=ft(m,oc),I=new fi;I.init();const pn=new Qr(1),sc=new Ql(pn),ac=new Xr,Fe=new nc(I),ae=`#version 300 es
in vec2 position;
void main() {
...
void main() {
  outColor = v_color;
}`,oe=re(m,[dc,mc]);re(m,[ae,cc]);const pc=re(m,[ae,fc]),xc=re(m,[ae,Yr]);re(m,[ae,Yr]);const lt=re(m,[ae,lc]),vc=re(m,[ae,uc]),Ht=re(m,[ae,hc]),bc=re(m,[ae,rc]),se=Xi,yc=re(m,[ae,ic]),xn=[],Dt=32;for(var et=0;et<=Dt;et++)xn.push(Math.sin(et*Math.PI*2/Dt),Math.cos(et*Math.PI*2/Dt));function Ec(t){const e=[],n=[],{ball:r}=Fe.data.state,i=se.scaling([r.size,r.size,r.size]),o=se.translation([r.position[0]/r.size,r.position[1]/r.size,0]),s=se.multiply(i,o);s.forEach((f,u)=>{e.push(f)}),n.push(r.color[0],r.color[1],r.color[2],1),s.forEach((f,u)=>{e.push(f)}),n.push(r.color[0],r.color[1],r.color[2],1);const l=ft(m,{position:{numComponents:2,data:xn},color:{numComponents:4,data:n,divisor:1},matrix:{numComponents:16,data:e,divisor:1}}),c=mn(m,oe,l);m.useProgram(oe.program),ze(m,oe,c),At(m,t),Et(m,c,m.TRIANGLE_FAN,c.numElements,0,1)}function gc(t){const e=[],n=[],{balls:r}=Fe.data.state;for(let a=0;a<r.length;a++){const l=r[a],c=se.scaling([l.size,l.size,l.size]),f=se.translation([l.position[0]/l.size,l.position[1]/l.size,0]);se.multiply(c,f).forEach((h,p)=>{e.push(h)}),n.push(l.color[0],l.color[1],l.color[2],1)}const o=ft(m,{position:{numComponents:2,data:xn},color:{numComponents:4,data:n,divisor:1},matrix:{numComponents:16,data:e,divisor:1}}),s=mn(m,oe,o);m.useProgram(oe.program),ze(m,oe,s),At(m,t),Et(m,s,m.TRIANGLE_FAN,s.numElements,0,r.length)}function Ac(t){const e=[],n=[],{paddles:r}=Fe.data.state;for(let l=0;l<r.length;l++){const c=r[l],f=se.scaling([c.size[0],c.size[1],1]),u=se.translation([c.position[0]/c.size[0],c.position[1]/c.size[1],0]);se.multiply(f,u).forEach((p,d)=>{e.push(p)}),n.push(c.color[0],c.color[1],c.color[2],1)}const s=ft(m,{position:{numComponents:2,data:[1,1,1,-1,-1,-1,-1,1]},color:{numComponents:4,data:n,divisor:1},matrix:{numComponents:16,data:e,divisor:1}}),a=mn(m,oe,s);m.useProgram(oe.program),ze(m,oe,a),At(m,t),Et(m,a,m.TRIANGLE_FAN,a.numElements,0,r.length)}function Wr(t,e,n,r){Ec(e),gc(e),Ac(e)}pn.listeners.push({updateSize:({width:t,height:e})=>{m.canvas.width=t,m.canvas.height=e}});let vn=!1;I.addButton({name:"Save Image",fn:()=>{vn=!0}});const _c=()=>{var e=document.getElementById("webgl").toDataURL(),n=document.createElement("a");n.download="canvas_image.png",n.href=e,n.click(),vn=!1},q=4*128,Ee=q,g={lightEmittersWithCurrent:ye(m,[{internalFormat:m.RGBA8,format:m.RGBA,mag:m.LINEAR,min:m.LINEAR,wrap:m.CLAMP_TO_EDGE}],q,Ee),distance:ye(m,[{internalFormat:m.R8,format:m.R,mag:m.LINEAR,min:m.LINEAR,wrap:m.CLAMP_TO_EDGE}],q,Ee),fill:ye(m,[{internalFormat:m.RGB8,format:m.RGB,mag:m.NEAREST,min:m.NEAREST,wrap:m.CLAMP_TO_EDGE}],q,Ee),spare:ye(m,[{internalFormat:m.RGB8,format:m.RGB,mag:m.NEAREST,min:m.NEAREST,wrap:m.CLAMP_TO_EDGE}],q,Ee),quadCascadeRT:ye(m,[{internalFormat:m.RGBA16F,format:m.RGBA,mag:m.LINEAR,min:m.LINEAR,wrap:m.CLAMP_TO_EDGE}],q,Ee),spareQuadCascadeRT:ye(m,[{internalFormat:m.RGBA16F,format:m.RGBA,mag:m.LINEAR,min:m.LINEAR,wrap:m.CLAMP_TO_EDGE}],q,Ee),spareQuadCascadeFinalRT:ye(m,[{internalFormat:m.RGBA16F,format:m.RGBA,mag:m.LINEAR,min:m.LINEAR,wrap:m.CLAMP_TO_EDGE}],q,Ee)};I.addColor({displayName:"Color",defaultValue:[1,1,1],callback:t=>{Fe.commands.push(new UpdateColorCommand(t))}});const zn=m.getExtension("EXT_disjoint_timer_query_webgl2"),It=m.createQuery();var Lt=!1,$n=!1;function wc(t){m.viewport(0,0,m.canvas.width,m.canvas.height),Q(m,lt,Z,{color:[0,0,0,0]},g.lightEmittersWithCurrent),Wr(t,g.lightEmittersWithCurrent)}function Tc(t,e){const n=I.addNumber({displayName:"Start Depth",defaultValue:Math.log2(q)-3,min:1,max:Math.log2(q)-3,step:1}).value,r=1*Math.SQRT2/g.quadCascadeRT.width,o=Math.log2(Math.SQRT2/r),s=e===0?0:r*Math.pow(2,o*(e-1)/n),a=e==n?Math.SQRT2:r*Math.pow(2,o*e/n),l=r*Math.pow(2,o*(e+1)/n);Q(m,bc,Z,{renderResolution:[m.canvas.width,m.canvas.height],resolution:[g.quadCascadeRT.width,g.quadCascadeRT.height],maxSteps:I.addNumber({displayName:"Max Steps",defaultValue:32,min:1,max:128,step:1}).value,tDistance:g.distance.attachments[0],tColor:g.lightEmittersWithCurrent.attachments[0],startDepth:n,current:{depth:e,minDistance:s,maxDistance:a},deeper:{depth:e,minDistance:a,maxDistance:l},debug:{continousBilinearFix:I.addNumber({displayName:"Continuous Bilinear Fix",defaultValue:!0}).value,cornerProbes:I.addNumber({displayName:"Corner Probes",defaultValue:!0}).value,showSampleUv:I.addNumber({displayName:"Show Sample Uv",defaultValue:!1}).value,showProbeUv:I.addNumber({displayName:"Show Probe Uv",defaultValue:!1}).value,showDirection:I.addNumber({displayName:"Show Direction Uv",defaultValue:!1}).value,noFix:I.addNumber({displayName:"No Fix",defaultValue:!1}).value,quadSample:I.addNumber({displayName:"Quad Sample",defaultValue:!1}).value,finalDepth:I.addNumber({displayName:"Final Depth",defaultValue:0,min:0,max:8,step:1}).value},tPrevCascade:g.quadCascadeRT.attachments[0]},g.spareQuadCascadeRT),[g.spareQuadCascadeRT,g.quadCascadeRT]=[g.quadCascadeRT,g.spareQuadCascadeRT]}function Sc(t){Q(m,lt,Z,{color:[0,0,0,0]},g.spare),[g.fill,g.spare]=[g.spare,g.fill];for(var e=Math.ceil(Math.log2(q));e>=0;e--)Q(m,vc,Z,{resolution:[g.fill.width,g.fill.height],jumpSize:1<<e,tPrev:g.fill.attachments[0],tLine:g.lightEmittersWithCurrent.attachments[0]},g.spare),[g.fill,g.spare]=[g.spare,g.fill];Q(m,xc,Z,{resolution:[g.fill.width,g.fill.height],tPrev:g.fill.attachments[0]},g.distance)}function Cc(){Q(m,pc,Z,{renderTarget:[I.addNumber({displayName:"minx",defaultValue:0,min:0,max:1,step:.01}).value,I.addNumber({displayName:"miny",defaultValue:0,min:0,max:1,step:.01}).value,I.addNumber({displayName:"maxx",defaultValue:1,min:0,max:1,step:.01}).value,I.addNumber({displayName:"maxy",defaultValue:1,min:0,max:1,step:.01}).value],resolution:[g.quadCascadeRT.width,g.quadCascadeRT.height],tPrev:g.quadCascadeRT.attachments[0]},g.spareQuadCascadeFinalRT),Q(m,Ht,Z,{resolution:[m.canvas.width,m.canvas.height],tPrev:g.spareQuadCascadeFinalRT.attachments[0]})}function Rc(){Q(m,yc,Z,{resolution:[g.spareQuadCascadeRT.width,g.spareQuadCascadeRT.height],tPrevCascade:g.quadCascadeRT.attachments[0]},g.spareQuadCascadeFinalRT)}function jr(t){at.begin(),pn.update(),ac.update(Fe,sc.getState()),Fe.update(),ql(m.canvas),wc(t),Sc();let e=I.addNumber({displayName:"Initial Depth",defaultValue:Math.log2(q)-3,min:1,max:Math.log2(q)-3,step:1}).value;for(Q(m,lt,Z,{color:[0,0,0,0]},g.quadCascadeRT),Q(m,lt,Z,{color:[0,0,0,0]},g.spareQuadCascadeFinalRT),Lt||(m.beginQuery(zn.TIME_ELAPSED_EXT,It),Lt=!0);e>=I.addNumber({displayName:"Final Depth",defaultValue:0,min:0,max:8,step:1}).value;)Tc(t,e),e--;switch(Lt&&!$n&&($n=!0,m.endQuery(zn.TIME_ELAPSED_EXT)),Q(m,Ht,Z,{resolution:[m.canvas.width,m.canvas.height],tPrev:g.lightEmittersWithCurrent.attachments[0]}),I.addEnum({displayName:"Render Mode",defaultValue:"Render Cascade",options:["Render Cascade","Cascade Levels"]}).value){case"Cascade Levels":Cc();break;case"Render Cascade":default:Rc();break}if(Wr(t,g.spareQuadCascadeFinalRT),Q(m,Ht,Z,{resolution:[m.canvas.width,m.canvas.height],tPrev:g.spareQuadCascadeFinalRT.attachments[0]}),vn&&_c(),m.getQueryParameter(It,m.QUERY_RESULT_AVAILABLE)){const r=m.getQueryParameter(It,m.QUERY_RESULT);console.log("ELAPSED: ",r/1e6)}at.end(),requestAnimationFrame(jr)}requestAnimationFrame(jr);
//# sourceMappingURL=index-07e7346c.js.map
