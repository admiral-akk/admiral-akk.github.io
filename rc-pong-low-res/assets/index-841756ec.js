...
void main() {\r
  ...
  outColor.w = 1.;\r
}`,ut=new xi;ut.showPanel(0);document.body.appendChild(ut.dom);const m=document.getElementById("webgl").getContext("webgl2");ql(m);function Q(t,e,n,r,i=null,o=null){t.useProgram(e.program),$e(t,e,n),Or(e,r),Tt(t,i),o&&t.viewport(o[0],o[1],o[2],o[3]),_t(t,n)}const sc={position:{numComponents:3,data:[-1,-1,0,1,-1,0,-1,1,0,-1,1,0,1,-1,0,1,1,0]}},Z=mt(m,sc),I=new hi;I.init();const De=new Zr(2),ac=new Zl(De),lc=new Yr,Fe=new rc(I),ae=`#version 300 es
in vec2 position;
void main() {
